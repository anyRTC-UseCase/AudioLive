...
public class ARApplication extends Application {
    ...
    private void kalle() {
        Kalle.setConfig(KalleConfig.newBuilder()
                ...
                .addInterceptor(new LoggerInterceptor("AR_AudioMic", BuildConfig.DEBUG))
                .build());
    }
    ...
    private class LoginInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (originResponse.code() ==401){  //登录信息过期
                Toast.makeText(ARApplication.this, "登录信息过期,请重新登录", Toast.LENGTH_SHORT).show();
                *//*Intent intent =new Intent(YunApplication.this,MainActivity.class);
