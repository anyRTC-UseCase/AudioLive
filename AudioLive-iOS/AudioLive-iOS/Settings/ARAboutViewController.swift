...
class ARAboutViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = RGBA(r: 10, g: 22, b: 33, a: 1)
        navigationItem.leftBarButtonItem = createBarButtonItem(title: "关于")
        ...
        officialButton.frame = CGRect(x: (ARScreenWidth - 200) / 2, y: ARScreenHeight - 56 - (isFullScreen() ? 88 : 44), width: 200, height: 12)
