...
class ARMainViewController: UICollectionViewController {
    ...
    lazy var createButton: UIButton = {
        ...
        button.frame = CGRect(x: ARScreenWidth - 65, y: ARScreenHeight - (self.tabBarController?.tabBar.frame.size.height)! - 144, width: 55, height: 55)
    ...
    override func viewDidLoad() {
        ...
        flowLayout?.itemSize = CGSize(width: width, height: width * 1.05)
    ...
    @objc func createPlaceholder() {
        placeholderView.showPlaceholderView(view, placeholderImageName: "icon_placeholder", placeholderTitle: "暂时没有房间 \n请点击下方“+”创建房间") {
